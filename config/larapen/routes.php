...
if (in_array(config('settings.seo.listing_permalink', '{slug}/{id}'), $postPermalinks)) {
	$routes['post'] = config('settings.seo.listing_permalink', '{slug}/{id}') . config('settings.seo.listing_permalink_ext', '');
}
