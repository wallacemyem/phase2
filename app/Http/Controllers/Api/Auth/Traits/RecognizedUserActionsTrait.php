...
trait RecognizedUserActionsTrait
{
	 ...
	 * Match User's listings (posted as Guest)
	 *
	 * @param $user
	 */
	...
	/**
	 * After Email or Phone verification (from Listing creation), match User's listings (posted as Guest) & User's data (if missed)
	 *
	 * @param $post
	 */
