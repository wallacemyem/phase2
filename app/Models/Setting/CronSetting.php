...
class CronSetting
{
	...
	public static function getValues($value, $disk)
	{
		if (empty($value)) {
			...
			if (!isset($value['unactivated_listings_expiration'])) {
				$value['unactivated_listings_expiration'] = '30';
			}
			if (!isset($value['activated_listings_expiration'])) {
				$value['activated_listings_expiration'] = '30';
			}
			if (!isset($value['archived_listings_expiration'])) {
				$value['archived_listings_expiration'] = '7';
			}
			if (!isset($value['manually_archived_listings_expiration'])) {
				$value['manually_archived_listings_expiration'] = '90';
			}
