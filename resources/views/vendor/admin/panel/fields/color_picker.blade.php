...
@if ($xPanel->checkIfFieldIsFirstOfItsType($field, $fields))
    ...
    @push('crud_fields_styles')
        <link rel="stylesheet" href="{{ asset('vendor/admin/plugins/bootstrap-colorpicker/3.4.0/css/bootstrap-colorpicker.css') }}" />
    @endpush

    {{-- FIELD JS - will be loaded in the after_scripts section --}}
    @push('crud_fields_scripts')
        <script type="text/javascript" src="{{ asset('vendor/admin/plugins/bootstrap-colorpicker/3.4.0/js/bootstrap-colorpicker.js') }}"></script>
    @endpush
