...
if (!empty(config('settings.style.btn_listing_border_color'))) {
	...
	$cssBuffer .= '.navbar.navbar-site ul.navbar-nav > li.postadd > a.btn-add-listing,';
	$cssBuffer .= '#homepage a.btn-add-listing {';
	$cssBuffer .= 'border-color: ' . config('settings.style.btn_listing_border_color') . ';';
	$cssBuffer .= '}';
}
if (!empty(config('settings.style.btn_listing_text_color'))) {
	...
	$cssBuffer .= '.navbar.navbar-site ul.navbar-nav > li.postadd > a.btn-add-listing,';
	$cssBuffer .= '#homepage a.btn-add-listing {';
	$cssBuffer .= 'color: ' . config('settings.style.btn_listing_text_color') . ' !important;';
	$cssBuffer .= '}';
}
...
if (!empty(config('settings.style.btn_listing_border_color_hover'))) {
	...
	$cssBuffer .= '#homepage a.btn-add-listing:hover,';
	$cssBuffer .= '#homepage a.btn-add-listing:focus {';
	$cssBuffer .= 'border-color: ' . config('settings.style.btn_listing_border_color_hover') . ' !important;';
	$cssBuffer .= '}';
}
if (!empty(config('settings.style.btn_listing_text_color_hover'))) {
	...
	$cssBuffer .= '#homepage a.btn-add-listing:hover,';
	$cssBuffer .= '#homepage a.btn-add-listing:focus {';
	$cssBuffer .= 'color: ' . config('settings.style.btn_listing_text_color_hover') . ' !important;';
	$cssBuffer .= '}';
}
